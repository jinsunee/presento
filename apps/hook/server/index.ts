 ...
 *
 * Reads slide JSON from stdin, opens presentation UI in browser.
 * User reviews slides with TTS narration, leaves feedback.
 * Outputs feedback to stdout for Claude Code to process.
 */
